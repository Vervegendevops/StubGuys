      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text("-\$2,520.85",style: TextStyle(
                fontSize: 36,
            ...
            Row(
              ...
              children: [
                ...
                Text("25/10/2023, 09:38:59",style: TextStyle(
                  fontSize: 13,
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Amount Withdrawn",style: TextStyle(
                    fontSize: 13,
                    color: Color(0xffC0C0C0)
                ),),
                Text("-\$2,501.85",style: TextStyle(
                    fontSize: 13,
                    color: Color(0xff201335)
                ),)
              ],
            ...
            Row(
              ...
              children: [
                ...
                Text("010929309203",style: TextStyle(
                    fontSize: 13,
                    color: Color(0xff201335)
                ),)
              ],
            ...
            Row(
              ...
              children: [
                ...
                Text("STUBGMGE7Z",style: TextStyle(
                    fontSize: 13,
                    color: Color(0xff201335)
                ),)
              ],
