        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("We have sent a verification code on your phone number + 1 831 *** 992. Please enter verification code below.", style: TextStyle(
                fontSize: 16,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: widget.isFocused ? const Color(0xff8DC73F) : const Color(0xffF1F1F2),
            width: 1,
          ),
        ),
        child: TextField(
